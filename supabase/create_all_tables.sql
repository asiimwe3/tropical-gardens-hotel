...
grant insert on public.guest_messages to anon;
...
grant all on public.hotel_settings to authenticated;
...
create policy "Public can create guest messages" on public.guest_messages for insert to anon, authenticated with check (true);
